  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>E-Shop</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               E - Shop Head Office
               Email:support@e-shop.com <br>
               Mob: 1245454545 <br>
               Swat 19830,kabal:#4 <br>
  ...
  <table width="100%">
    ...
    <tbody>
     @foreach($orderItem as $item)
      <tr class="font">
        <td align="center">
            <img src="{{ public_path('image/product/product_thambnail/'.$item->product->product_thambnail)  }}" height="60px;" width="60px;" alt="">
        </td>
