...
<h6 class="mb-0 text-uppercase">Return Order List</h6>
							...
							<table id="example2" class="table table-striped table-bordered">
								...
								<thead>
									<tr>
										...
										<th class="text-center " width="15%">Reason </th>
								...
								<tbody>
									@foreach ($orders as $key => $item)
										...
										<td class="text-center " style="color: rgb(8, 8, 8)"> {{ $item->return_reason }}</td>
										...
										<td>
									        ...
									        <a href="{{ route ('pending-to-approve',$item->id ) }}" class="btn btn-sm btn-info ">  Approve </a>
