                        ...
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="{{route('product-detail',$feature->id)}}">
                                    <img src="{{asset('image/product/product_thambnail/'.$feature->product_thambnail)}}" alt="Product Image" data-echo="{{asset('image/product/product_thambnail/'.$feature->product_thambnail)}}" height="250px" width="100px">
                                </a>
