                        ...
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="{{route('product-detail',$feature->id)}}">
                                    <img src="{{asset('/image/product/product_thambnail/'.$feature->product_thambnail)}}"  alt="Product Image" style="height: 200px; width: 250px;"  data-echo="{{asset('image/product/product_thambnail/'.$feature->product_thambnail)}}">
                                </a>
                ...
                <div class="sidebar-widget widget-slider">
                    <div class="sidebar-slider normal-slider">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="{{route('product-detail',$feature->id)}}">
                                    <img src="{{asset('/image/product/product_thambnail/'.$feature->product_thambnail)}}"  id="pimage" alt="Product Image" height="250px" width="100px" data-echo="{{asset('/image/product/product_thambnail/'.$feature->product_thambnail)}}">
                                </a>
                                <div class="product-action">
                                    <button class="btn btn-primary icon"  type="button" data-toggle="modal" data-target="#exampleModal" id="{{$feature->id}}" 
                                         onclick="productView(this.id)"> <i class="fa fa-shopping-cart" ></i> </button>
